<template>
  <div
    class="fixed z-10 inset-0 overflow-y-auto" id="modal"
      ...
      >
        ...
        <div class="py-4 text-left px-6">
          ...
          <div class="flex justify-between items-center pb-4">
            ...
            <!-- Modal Close Button -->
            <div class="modal-close cursor-pointer z-50" @click.prevent="toggleAuthModal" @keyup.prevent="toggleAuthModal">
          ...
          <vee-form v-show="tab === 'register'">
            ...
            <div class="mb-3 pl-6">
              ...
              <label for="accept term" class="inline-block">Accept terms of service</label>
            </div>
            <button
              type="submit"
              class="block w-full bg-purple-600 text-white py-1.5 px-3 rounded transition hover:bg-purple-700"
...
export default {
  ...
  computed: {
    ...
    // authModalShow() {
    //   return {
    //     hidden: !this.$store.getters.authModalShow,
    //   };
